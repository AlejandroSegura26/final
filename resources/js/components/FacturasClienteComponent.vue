                    ...
                    <table class="table table-bordered table-striped table-sm">
                        ...
                        <tbody>
                          ...
                          <td>
                           ...
                           <button type="button" @click="abrirModal('factura','pagar',factura,factura.id)" class="btn btn-warning btn-sm">
            ...
            <div class="modal-dialog modal-primary modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" v-text="tituloModal"></h4><br>
                    ...
                    <div class="modal-body">
                       ...
                       <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <label class="col-md-3 form-control-label" v-text="total" for="text-input"></b></label>
                                </div>
                            </div>
                    <div class="form-group row">
                                <label class="col-md-3 form-control-label" for="text-input">Restante</label>
                                <div class="col-md-9">
                                    <label class="col-md-3 form-control-label" v-text="restante" for="text-input"></b></label>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" v-if="tipoAccion==2" class="btn btn-warning" @click="actualizarFactura()">Pagar</button>
    ...
    export default {
        ...
        methods: {
            ...
            listarFactura(page,buscar,criterio) {
                ...
                var url = '/facturaCliente?page=' + page + '&buscar=' + buscar + '&criterio=' + criterio;
              ...
              actualizarFactura() {
                ...
                axios.put('/factura/pago',{
                  ...
                  else
                    {
                       swalWithBootstrapButtons.fire(
                            '¡Error!',
                            'No se puede realizar el pago ya que el monto supera el adeudo .',
                            'error'
                            ) 
                    ...
                    case "factura":
                    {
                        switch (accion) {
                            ...
                            case 'pagar':
                            {
                                ...
                                this.total=data['monto'];
                                this.restante=data['monto']-data['monto_pagado'];
                                this.tipoAccion = 2;
                                this.id_factura=id;
                                this.monto=0;
                                break;
