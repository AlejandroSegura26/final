                    ...
                    <table class="table table-bordered table-striped table-sm">
                        ...
                        <tbody>
                            <tr v-for="problema in arrayProblema" :key="problema.id">
                                <td v-if="problema.rol_id == 4">
                                    <template v-if="problema.estado == 1">
                                     <button type="button" @click="abrirModal('problema','asignar',problema,problema.id)" class="btn btn-warning btn-sm">
            ...
            <div class="modal-dialog modal-primary modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" v-if="tipoAccion==2" class="btn btn-warning" @click="asignarProgramador()">Asignar</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            asignarProgramador() {
                ...
                axios.put('/problema/asignarProgramador',{
            ...
            validarProblema() {
                ...
                if (!this.usuario_id) this.errorMostrarMsjProblema.push("Seleccione un programador.");
